...
public class VNPayController {
    ...
    public PaymentTransaction makePaymentTransaction(Map<String, String> response) throws IncompleteTransactionException, FailedTransactionException, ReverseTransactionException, UnrecognizedException, ParseException {
        if (response == null) {
            return null;
        }
